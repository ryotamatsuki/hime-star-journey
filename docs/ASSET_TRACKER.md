...
| bg_star_map | `public/assets/generated/backgrounds/star_map_bg.png` | 星地図 | generated | 後続フェーズ接続用 |
...
| ui_star_icon_locked | `public/assets/generated/ui/star_icon_locked.png` | 未解放星 | pending | 完成品質化は後続 |
| ui_star_icon_unlocked | `public/assets/generated/ui/star_icon_unlocked.png` | 解放済み星 | pending | 完成品質化は後続 |
| ui_star_icon_cleared | `public/assets/generated/ui/star_icon_cleared.png` | クリア済み星 | pending | 完成品質化は後続 |
